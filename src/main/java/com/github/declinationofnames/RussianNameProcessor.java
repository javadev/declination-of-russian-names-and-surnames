...
public final class RussianNameProcessor {
    ...
    static Map<String, Map<String, List<Object>>> rules =
    ...
    private static String pick(
            String word, String sex, String gcase, List<Object> rules, boolean matchWholeWord) {
    ...
    private static boolean ruleMatch(
            String word, String sex, final Object rule, boolean matchWholeWord) {
        ...
        for (int i = 0, n = localRule.get("test").size(); i < n; i++) {
            String test =
                    matchWholeWord
                            ...
                            : word.substring(
                                    Math.max(
                                            word.length() - localRule.get("test").get(i).length(),
                                            0));
